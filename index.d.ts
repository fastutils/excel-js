declare namespace Excel {
    ...
    function transform<T>(sheetIndex : number, excel : string | Excel, parser : (row: Row) => T) : T[];
    function transform<T>(sheetIndex : number, excel : string | Excel, startIndex : number, parser : (row: Row) => T) : T[];
    function transform<T>(sheetIndex : number, excel : string | Excel, startIndex : number, count : number, parser : (row: Row) => T) : T[];
    function transform<T>(excel : string | Excel, parser : (row: Row) => T) : T[];
    function transform<T>(excel : string | Excel, startIndex : number, parser : (row: Row) => T) : T[];
    function transform<T>(excel : string | Excel, startIndex : number, count : number, parser : (row: Row) => T) : T[];
    ...
    function transform<T>(sheetIndex : number, excel : string | Excel, creator : () => T, ...setters : ((T, Cell) => void)[]) : T[];
    function transform<T>(sheetIndex : number, excel : string | Excel, startIndex : number, creator : () => T, ...setters : ((T, Cell) => void)[]) : T[];
    function transform<T>(sheetIndex : number, excel : string | Excel, startIndex : number, count : number, creator : () => T, ...setters : ((T, Cell) => void)[]) : T[];
    function transform<T>(excel : string | Excel, creator : () => T, ...setters : ((T, Cell) => void)[]) : T[];
    function transform<T>(excel : string | Excel, startIndex : number, creator : () => T, ...setters : ((T, Cell) => void)[]) : T[];
    function transform<T>(excel : string | Excel, startIndex : number, count : number, creator : () => T, ...setters : ((T, Cell) => void)[]) : T[];
    ...
    function map<T>(excel : string | Excel, creator : () => T, ...properties : PropertyInfo<T, any>[]) : T[];
    function map<T>(excel : string | Excel, startIndex : number, creator : () => T, ...properties : PropertyInfo<T, any>[]) : T[];
    function map<T>(excel : string | Excel, startIndex : number, count : number, creator : () => T, ...properties : PropertyInfo<T, any>[]) : T[];
    ...
    function mapCollectErrors<T>(sheetIndex : number, excel : string | Excel, creator : () => T, ...properties : PropertyInfo<T, any>[]) : T[];
    function mapCollectErrors<T>(sheetIndex : number, excel : string | Excel, startIndex : number, creator : () => T, ...properties : PropertyInfo<T, any>[]) : T[];
    function mapCollectErrors<T>(sheetIndex : number, excel : string | Excel, startIndex : number, count : number, creator : () => T, ...properties : PropertyInfo<T, any>[]) : T[];
